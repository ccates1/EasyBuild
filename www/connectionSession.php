      ...
      if(mysqli_num_rows($query) != 0) {
        ...
        if($isbuilder == true) { // if the recipient is a builder (sender is a home owner)
          ...
          if(empty($errors)) {
            ...
            $sql = mysqli_query($dbc, "SELECT * FROM Sessions WHERE name = '$sessionname';");
            ...
            $query3 .= "INSERT INTO Subs (`checklistitem_id`, `description`, `isCompleted`, `session_id_fk`) SELECT id, 'Plumbing', '0', session_id FROM ChecklistItems WHERE step = '4' AND session_id = '$id';";

            $query3 .= "INSERT INTO Subs (`checklistitem_id`, `description`, `isCompleted`, `session_id_fk`) SELECT id, 'Electrical', '0', session_id FROM ChecklistItems WHERE step = '4' AND session_id = '$id';";

            $query3 .= "INSERT INTO Subs (`checklistitem_id`, `description`, `isCompleted`, `session_id_fk`) SELECT id, 'HVAC', '0', session_id FROM ChecklistItems WHERE step = '4' AND session_id = '$id';";
            ...
            $query3 .= "INSERT INTO Subs (`checklistitem_id`, `description`, `isCompleted`, `session_id_fk`) SELECT id, 'Cabinets', '0', session_id FROM ChecklistItems WHERE step = '8' AND session_id = '$id';";

            $query3 .= "INSERT INTO Subs (`checklistitem_id`, `description`, `isCompleted`, `session_id_fk`) SELECT id, 'Flooring', '0', session_id FROM ChecklistItems WHERE step = '8' AND session_id = '$id';";

            $query3 .= "INSERT INTO Subs (`checklistitem_id`, `description`, `isCompleted`, `session_id_fk`) SELECT id, 'Interior Trim/Doors', '0', session_id FROM ChecklistItems WHERE step = '8' AND session_id = '$id';";
            ...
            $query3 .= "INSERT INTO Subs (`checklistitem_id`, `description`, `isCompleted`, `session_id_fk`) SELECT id, 'Final Paint', '0', session_id FROM ChecklistItems WHERE step = '9' AND session_id = '$id';";

            $query3 .= "INSERT INTO Subs (`checklistitem_id`, `description`, `isCompleted`, `session_id_fk`) SELECT id, 'Fixtures', '0', session_id FROM ChecklistItems WHERE step = '9' AND session_id = '$id';";

            $query3 .= "INSERT INTO Subs (`checklistitem_id`, `description`, `isCompleted`, `session_id_fk`) SELECT id, 'Appliances', '0', session_id FROM ChecklistItems WHERE step = '9' AND session_id = '$id';";

            $query3 .= "INSERT INTO Subs (`checklistitem_id`, `description`, `isCompleted`, `session_id_fk`) SELECT id, 'Landscaping/Driveway', '0', session_id FROM ChecklistItems WHERE step = '9' AND session_id = '$id';";

            $query3 .= "INSERT INTO Subs (`checklistitem_id`, `description`, `isCompleted`, `session_id_fk`) SELECT id, 'Attic Insulation', '0', session_id FROM ChecklistItems WHERE step = '9' AND session_id = '$id';";
