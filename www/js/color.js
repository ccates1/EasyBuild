...
PICKER = {
    ...
    show: function () {
        ...
        PICKER.$colors  = $('<canvas width="300" height="100" style="border-radius:0%;" ></canvas>');
        PICKER.$colors.css({
            'position': 'absolute',
            'top':140,
            'left': position.left+100,
            'cursor': 'crosshair',//mouse
            'display': 'none'
        });
        //$('body').append(PICKER.$colors.fadeIn());
        $('#myModal').append(PICKER.$colors.fadeIn());
        ...
        PICKER.$colors
            .click(function (e) {
                ...
                document.getElementById('colorChoice').innerHTML = new_color;
    ...
    bind_inputs: function () {
        $('div[type="color-picker"]').not('.color-picker-binded').each(function () {
